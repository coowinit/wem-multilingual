...
final class WEM_ML_Admin {
    ...
    public static function render_page() {
        ...
        <div class="wrap">
            ...
            <p><strong>Experimental Core · Step 5</strong></p>
            <p>当前页面用于验证 Slug Repository 与 Translation Repository。前台内容 Overlay 尚未启用。</p>
            ...
            <?php if ( empty( $title_rows ) ) : ?>
                <p>还没有 post_title Source Unit。</p>
            <?php else : ?>
